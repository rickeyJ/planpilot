class PagesController < ApplicationController
  ...
  @@page_data_table={
                     ...
                     3 => {
                       ...
                       checkbox_list: [{label: "I'm a smoker", popup_html: '<input class="doctornameinput inline form-control" type="text" placeholder="Enter doctor name"><button class="btn btn-default submit">Go</button>'}, {label: "I have an ongoing illness"}, {label: "I take prescription medication"}, {label: "I have a favorite doctor"},],
                       results_data: [
